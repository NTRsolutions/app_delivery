<div class="admins index">
	...
	<div class="row">
					...
					<div class="panel-heading"><?php echo __('Ações'); ?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-menu-left"></span>&nbsp;&nbsp;'.__('Voltar'), array('action' => 'edit', $gerente['Gerente']['id']), array('escape' => false)); ?> </li>
							</ul>
						</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
		...
		<div class="col-md-9">
			...
			<?php 
				echo $this->Form->create('Gerente', array('action' => 'altera'));
